...
//            criterioList.clear();
    ...
    public static int generarCodTD(int codTipoTramite) {
        return (int) (System.currentTimeMillis() + codTipoTramite + 1);
    }   
    // registrarTramite()
    public void registrarTramite() throws RegistrarTramiteException {
        ...
        tramiteCreado.setNroTramite(generarNroTramite(tipoTramiteEncontrado.getCodTipoTramite()));
    ...
    public void registrarDocumentacion(int codTD, DTOFile archivoTD, int nroTramite) {
        ...
        if (todasPresentadas) {
            ...
            for (Consultor consultor : consultorList) {
                System.out.println(consultor.getNombreConsultor()+ " - Max Trámites: " + consultor.getNumMaximoTramites());
            }
